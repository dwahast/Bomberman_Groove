...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="mapa_teste_bomba3">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n5">
        ...
        <edge from="n9" to="n9">
            <attr name="label">
                <string>rem: mapa que testa caso de 1 parede, 2 personagens e 1 bloco no range da explosão</string>
            </attr>
        </edge>
        <edge from="n4" to="n4">
            <attr name="label">
